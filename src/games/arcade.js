...
//Game Preview Images
//
auxl.game1Preview = './assets/img/previews/game1.jpg';
auxl.game2Preview = './assets/img/previews/game2.jpg';
auxl.game3Preview = './assets/img/previews/game3.jpg';
auxl.game4Preview = './assets/img/previews/game4.jpg';
auxl.game5Preview = './assets/img/previews/game5.jpg';
auxl.game6Preview = './assets/img/previews/game6.jpg';
auxl.game7Preview = './assets/img/previews/game7.jpg';
auxl.game8Preview = './assets/img/previews/game8.jpg';
auxl.game9Preview = './assets/img/previews/game9.jpg';
auxl.game10Preview = './assets/img/previews/game10.jpg';

//Sounds
//

//kenney
auxl.confirm1 = './assets/audio/kenney/confirmation_001.mp3';
auxl.confirm2 = './assets/audio/kenney/confirmation_002.mp3';
auxl.confirm3 = './assets/audio/kenney/confirmation_003.mp3';
auxl.confirm4 = './assets/audio/kenney/confirmation_004.mp3';
auxl.drop1 = './assets/audio/kenney/drop_001.mp3';
auxl.drop2 = './assets/audio/kenney/drop_002.mp3';
auxl.drop3 = './assets/audio/kenney/drop_003.mp3';
auxl.drop4 = './assets/audio/kenney/drop_004.mp3';
auxl.error7 = './assets/audio/kenney/error_007.mp3';
auxl.glass1 = './assets/audio/kenney/glass_001.mp3';
auxl.glass3 = './assets/audio/kenney/glass_003.mp3';
auxl.maximize6 = './assets/audio/kenney/maximize_006.mp3';
auxl.maximize7 = './assets/audio/kenney/maximize_007.mp3';
auxl.maximize8 = './assets/audio/kenney/maximize_008.mp3';
auxl.minimize6 = './assets/audio/kenney/minimize_006.mp3';
auxl.minimize7 = './assets/audio/kenney/minimize_007.mp3';
auxl.minimize8 = './assets/audio/kenney/minimize_008.mp3';
auxl.pluck1 = './assets/audio/kenney/pluck_001.mp3';
auxl.pluck2 = './assets/audio/kenney/pluck_002.mp3';
auxl.question3 = './assets/audio/kenney/question_003.mp3';
auxl.select2 = './assets/audio/kenney/select_002.mp3';
auxl.select6 = './assets/audio/kenney/select_006.mp3';
auxl.select7 = './assets/audio/kenney/select_007.mp3';
auxl.switch2 = './assets/audio/kenney/switch_002.mp3';
...
auxl.GameMenu = (gameMenuData) => {
	...
	//Window Material
	gameMenu.windowMaterial = {shader: "flat", color: "#2694ce", opacity: 1, side: 'double',};
	//Preview Material
	gameMenu.previewMaterial = {shader: "flat", color: "#FFFFFF", opacity: 1, side: 'double', src: gameMenu.preview, repeat: '1 1'};
	//Window Preview
...
const checkLowScore = (score, highScores) => {
	if(score < highScores.score1 || highScores.score1 === 0){
		highScores.score5 = JSON.parse(JSON.stringify(highScores.score4));
		highScores.name5 = JSON.parse(JSON.stringify(highScores.name4));
		highScores.score4 = JSON.parse(JSON.stringify(highScores.score3));
		highScores.name4 = JSON.parse(JSON.stringify(highScores.name3));
		...
		highScores.text = refreshHighScoreText(highScores);
		return highScores;
	} else if(score < highScores.score2 || highScores.score2 === 0){
		highScores.score5 = JSON.parse(JSON.stringify(highScores.score4));
		highScores.name5 = JSON.parse(JSON.stringify(highScores.name4));
		highScores.score4 = JSON.parse(JSON.stringify(highScores.score3));
		highScores.name4 = JSON.parse(JSON.stringify(highScores.name3));
		...
		highScores.text = refreshHighScoreText(highScores);
		return highScores;
	} else if(score < highScores.score3 || highScores.score3 === 0){
		highScores.score5 = JSON.parse(JSON.stringify(highScores.score4));
		highScores.name5 = JSON.parse(JSON.stringify(highScores.name4));
		highScores.score4 = JSON.parse(JSON.stringify(highScores.score3));
		highScores.name4 = JSON.parse(JSON.stringify(highScores.name3));
		...
		highScores.text = refreshHighScoreText(highScores);
		return highScores;
	} else if(score < highScores.score4 || highScores.score4 === 0){
		highScores.score5 = JSON.parse(JSON.stringify(highScores.score4));
		highScores.name5 = JSON.parse(JSON.stringify(highScores.name4));
		highScores.score4 = score;
		highScores.name4 = auxl.local.profile.shortname;
		highScores.text = refreshHighScoreText(highScores);
		return highScores;
	} else if(score < highScores.score5 || highScores.score5 === 0){
		highScores.score5 = score;
		highScores.name5 = auxl.local.profile.shortname;
		highScores.text = refreshHighScoreText(highScores);
		return highScores;
...
sources: false,
sounds: {
	select: {src: auxl.drop1, autoplay: false, loop: false, volume: 1, on: 'mousedown'},
},
...
auxl.MemoryGame = (id) => {
	...
	material: {shader: "standard", color: "#3EB489", opacity: 1, metalness: 0.6, roughness: 0.4, emissive: "#3EB489", emissiveIntensity: 0.2, side: 'double', src: auxl.pattern44},
	...
	material: {shader: "standard", color: "#C14B76", opacity: 1, metalness: 0.6, roughness: 0.4, emissive: "#C14B76", emissiveIntensity: 0.2, side: 'double', src: auxl.pattern52},
	...
	material: {shader: "standard", color: "#ce782f", opacity: 1, metalness: 0.6, roughness: 0.4, emissive: "#ce782f", emissiveIntensity: 0.2, side: 'double', src: auxl.pattern47, repeat: '1 3'},
	...
	material: {shader: "standard", color: "#4b54c1", opacity: 1, metalness: 0.6, roughness: 0.4, emissive: "#4b54c1", emissiveIntensity: 0.2, side: 'double', src: auxl.pattern70},
	position: new THREE.Vector3(0.45,0,0),
	rotation: new THREE.Vector3(90,0,0),
	scale: new THREE.Vector3(1,1,1),
	animations: {
...
auxl.AddObjGenToTracker('memory', 'SpawnMemGame', 'DespawnMemGame');
...
auxl.SwipeLaunchGame = (id) => {
	...
	material: {shader: "standard", color: auxl.swipeLaunchGameColor.splitCompl[1], emissive: auxl.swipeLaunchGameColor.splitCompl[1], emissiveIntensity: 0.25, opacity: 1, src: auxl.pattern23},
	...
	text: false,
	geometry: {primitive: 'sphere', radius: 0.5},
	material: {shader: "standard", color: auxl.swipeLaunchGameColor.splitCompl[0], emissive: auxl.swipeLaunchGameColor.splitCompl[0], emissiveIntensity: 0.25, opacity: 1, src: auxl.pattern23},
	...
	swipeLaunch.swipeLaunchUI.layer.all.child2.core.core.text.value = '0 Pts';
	...
	function updatePowerText(text){
		swipeLaunch.swipeLaunchUI.GetChild('swipeLaunchUI3').ChangeSelf({property: 'text', value:{value:text + ' Pts'}})
	};
...
auxl.AddObjGenToTracker('swipeLaunch', 'SpawnSLGame', 'DespawnSLGame');
...
auxl.GuessHitGame = (id) => {
	...
	material: {shader: "standard", src: auxl.pattern15, repeat: '1 1', color: auxl.guessHitGameColor.compl, emissive: auxl.guessHitGameColor.compl, emissiveIntensity: 0.25, opacity: 1},
...
auxl.AddObjGenToTracker('guessHit', 'SpawnGHGame', 'DespawnGHGame');
...
auxl.DragDiffuse = (id) => {
	...
	material: {shader: "standard", color: auxl.dragDiffuseGameColor.splitCompl[1], emissive: auxl.dragDiffuseGameColor.splitCompl[1], emissiveIntensity: 0.25, opacity: 1, src: auxl.pattern76, repeat: '5 5'},
	...
	material: {shader: "standard", color: auxl.dragDiffuseGameColor.compl, emissive: auxl.dragDiffuseGameColor.compl, emissiveIntensity: 0.25, opacity: 1, src: auxl.pattern77},
...
auxl.AddObjGenToTracker('dragDiffuse', 'SpawnDDGame', 'DespawnDDGame');
...
auxl.SharpShooter = (id) => {
	...
	sharpShooter.targetData = {
		...
		material: {shader: "standard", color: auxl.sharpShooterGameColor.compl, emissive: auxl.sharpShooterGameColor.compl, emissiveIntensity: 0.1, opacity: 1, src: auxl.pattern54},
	...
	sharpShooter.gameSoundData = {
		...
		text: false,
		sounds: {
			start: {src: auxl.confirm2, autoplay: false, loop: false, volume: 1, on: 'gameStart'},
	...
	const UpdateTimer = (timer) => {
		...
		sharpShooter.countdownInterval = setInterval(() => {
			...
			if(sharpShooter.timer === 4000){
				sharpShooter.seconds = 1000;
			}
			if(sharpShooter.seconds <= 0 && sharpShooter.timer <= 4000){
				sharpShooter.seconds = 1000;
				sharpShooter.gameSound.EmitEvent('second');
			}
...
auxl.AddObjGenToTracker('sharpShooter', 'SpawnSSGame', 'DespawnSSGame');
...
auxl.PerfectScale = (id) => {
	...
	perfectScale.scalingUIParentData = {
		...
		text: false,
		sounds: {
			levelstart: {src: auxl.maximize6, autoplay: false, loop: false, volume: 1, on: 'levelStart'},
			gameover: {src: auxl.minimize6, autoplay: false, loop: false, volume: 1, on: 'gameOver'},
		},
		geometry: false,
		material: false,
	...
	sources: false,
	sounds: {
		confirm: {src: auxl.confirm1, autoplay: false, loop: false, volume: 1, on: 'mousedown'},
	},
	...
	sources: false,
	sounds: {
		spin: {src: auxl.switch2, autoplay: false, loop: false, volume: 1, on: 'mousedown'},
	},
	...
	//Game Complete
	const GameComplete = () => {
		perfectScale.scalingUIParent.EmitEvent('gameOver');
	...
	//Level Start
	const LevelStart = () => {
		perfectScale.scalingUIParent.EmitEvent('levelStart');
		perfectScale.level++;
...
auxl.AddObjGenToTracker('perfectScale', 'SpawnPSGame', 'DespawnPSGame');
...
auxl.Reflex7 = (id) => {
	...
	reflex7.targetData = {
		...
		animations:{
			...
			complete: {property: 'material.opacity', to: 1, dur: 250, delay: 0, loop: '8', dir: 'normal', easing: 'easeInOutElastic', elasticity: 400, autoplay: false, enabled: true, startEvents: 'complete'},
		},
		mixins: false,
		classes: ['a-ent'],
		components: {
	...
	const GameStart = () => {
		Reset();
		reflex7.target.EmitEvent('levelStart');
	...
	//Game Complete
	const GameComplete = () => {
		reflex7.target.EmitEvent('gameOver');
		reflex7.target.GetEl().classList.toggle('clickable', false);
		reflex7.target.EmitEvent('complete');
	...
	const UpdateAvgTime = (time) => {
		...
		reflex7.reflex7UI.GetChild('reflex7UI1').ChangeSelf({property:'text',value:{value: reflex7.hits + ' Left'}});
	}
	//Spawn Reflex 7
	const SpawnR7Game = () => {
...
auxl.AddObjGenToTracker('reflex7', 'SpawnR7Game', 'DespawnR7Game');
...
auxl.TapIt = (id) => {
	...
	sounds: {
		levelstart: {src: auxl.maximize6, autoplay: false, loop: false, volume: 1, on: 'levelStart'},
		gameover: {src: auxl.minimize6, autoplay: false, loop: false, volume: 1, on: 'gameOver'},
		mousedown: {src: auxl.drop1, autoplay: false, loop: false, volume: 1, on: 'mousedown'},
		select: {src: auxl.drop1, autoplay: false, loop: false, volume: 1, on: 'select'},
	},
	geometry: {primitive: 'cylinder', radius: 0.45, height: 0.15, openEnded: false, segmentsHeight: 2, segmentsRadial: 3, thetaStart: 0, thetaLength: 360},
	material: {shader: "standard", color: '#b967ff', emissive: '#b967ff', emissiveIntensity: 0.2, opacity: 1, src: auxl.pattern46, repeat: '4 4'},
	...
	text: false,
	sounds: {
		doubletap: {src: auxl.switch2, autoplay: false, loop: false, volume: 1, on: 'doubletap'},
		select: {src: auxl.switch2, autoplay: false, loop: false, volume: 1, on: 'select'},
	},
	geometry: {primitive: 'box', depth: 0.15, width: 0.75, height: 0.75},
	material: {shader: "standard", color: '#01cdfe', emissive: '#01cdfe', emissiveIntensity: 0.2, opacity: 1, src: auxl.pattern48, repeat: '4 4'},
	...
	text: false,
	sounds: {
		mouseenter: {src: auxl.pluck1, autoplay: false, loop: false, volume: 1, on: 'mouseenter'},
		select: {src: auxl.pluck1, autoplay: false, loop: false, volume: 1, on: 'select'},
	},
	...
	material: {shader: "standard", color: '#05ffa1', emissive: '#05ffa1', emissiveIntensity: 0.2, opacity: 1, src: auxl.pattern73, repeat: '4 4'},
	...
	geometry: {primitive: 'cylinder', radius: 0.45, height: 0.15, openEnded: false, segmentsHeight: 2, segmentsRadial: 3, thetaStart: 0, thetaLength: 360},
	material: {shader: "standard", color: '#ff71ce', emissive: '#ff71ce', emissiveIntensity: 0.2, opacity: 1, src: auxl.pattern84, repeat: '4 4'},
	...
	geometry: {primitive: 'cylinder', radius: 0.35, height: 0.15, openEnded: false, segmentsHeight: 2, segmentsRadial: 16, thetaStart: 0, thetaLength: 360},
	material: {shader: "standard", color: '#fffb96', emissive: '#fffb96', emissiveIntensity: 0.1, opacity: 1, src: auxl.pattern84, repeat: '4 4'},
	...
	const GameStart = () => {
		Reset();
		tapIt.tap.EmitEvent('levelStart');
	...
	const DoubleTap = () => {
		if(tapIt.doubleTapStart){
			if(tapIt.current === 'doubleTap'){
				Correct();
				tapIt.doubleTap.EmitEvent('doubletap')
			}
		} else {
			if(tapIt.current === 'doubleTap'){
...
auxl.AddObjGenToTracker('tapIt', 'SpawnTIGame', 'DespawnTIGame');
...
auxl.PopPopGame = (id) => {
	...
	text: false,
	sounds: {
		levelstart: {src: auxl.maximize6, autoplay: false, loop: false, volume: 1.5, on: 'levelStart'},
		gameover: {src: auxl.minimize6, autoplay: false, loop: false, volume: 1.5, on: 'levelOver'},
		fire: {src: auxl.select6, autoplay: false, loop: false, volume: 1.5, on: 'fire'},
	},
	...
	material: {shader: "standard", color: auxl.popPopGameColor.compl, emissive: auxl.popPopGameColor.compl, emissiveIntensity: 0.25, opacity: 1, src: auxl.pattern10, repeat: '1 1'},
	...
	text: false,
	sounds: {
		hit: {src: auxl.drop3, autoplay: false, loop: false, volume: 1.5, on: 'mouseenter'},
	},
	geometry:{primitive: 'dodecahedron', radius: 0.6, detail: 0},
	material: {shader: "standard", color: '#fffb96', emissive: '#fffb96', emissiveIntensity: 0.25, opacity: 1, src: auxl.pattern63, repeat: '2 2'},
	...
	const GameLoop = () => {
		...
		//Level Countdown
		popPop.base.EmitEvent('levelStart');
		Countdown(3);
		//Start Popping
		popPop.startTimeout = setTimeout(() => {
			popPop.base.EmitEvent('fire');
	...
	const LevelOver = () => {
		clearTimeout(popPop.levelTimeout);
		popPop.base.EmitEvent('levelOver');
...
auxl.AddObjGenToTracker('popPop', 'SpawnPPGame', 'DespawnPPGame');
...
auxl.HordeHaltGame = (id) => {
	...
	let spawnTotal = 1;
	let spawnRate = 2000;
	let resumeSpeed = 3000;
	let spawnDistance = 20;
	let enemyHealth = 3;

	hordeHalt.spawnTotal = spawnTotal;
	hordeHalt.levelKills = levelKills;
	hordeHalt.spawnRate = spawnRate;
	hordeHalt.resumeSpeed = resumeSpeed;
	hordeHalt.spawnDistance = spawnDistance;
	hordeHalt.enemyHealth = enemyHealth;
	...
	text: false,
	sounds: {
		countdown: {src: auxl.drop3, autoplay: false, loop: false, volume: 1, on: 'countdown'},
		levelstart: {src: auxl.maximize8, autoplay: false, loop: false, volume: 1, on: 'levelStart'},
		levelover: {src: auxl.minimize6, autoplay: false, loop: false, volume: 1, on: 'levelOver'},
		damage: {src: auxl.minimize7, autoplay: false, loop: false, volume: 1, on: 'damage'},
	},
	geometry: {primitive: 'box', depth: 1, width: 1, height: 1.25},
	material: {shader: "standard", color: auxl.hordeHaltGameColor.compl, emissive: auxl.hordeHaltGameColor.compl, emissiveIntensity: 0.1, opacity: 1, src: auxl.pattern76, repeat: '2 2'},
	...
	text: false,
	sounds: {
		stun: {src: auxl.select6, autoplay: false, loop: false, volume: 1, on: 'mousedown'},
		hit: {src: auxl.pluck2, autoplay: false, loop: false, volume: 1, on: 'hit'},
		kill: {src: auxl.minimize8, autoplay: false, loop: false, volume: 1, on: 'kill'},
	},
	geometry:{primitive: 'dodecahedron', radius: 0.6, detail: 0},
	material: {shader: "standard", color: '#cdef14', emissive: '#cdef14', emissiveIntensity: 0.25, opacity: 1, src: auxl.pattern78, repeat: '2 2'},
	position: new THREE.Vector3(-1,0,-15),
	rotation: new THREE.Vector3(0,0,0),
	scale: new THREE.Vector3(0.0001,0.0001,0.0001),
	animations: {
		spawn: {property: 'object3D.rotation.y', to: 0, dur: 100, delay: 0, loop: false, dir: 'normal', easing: 'linear', elasticity: 400, autoplay: true, enabled: true,},
		move: {property: 'position', to: hordeHalt.targetPos, dur: 20000, delay: 0, loop: false, dir: 'normal', easing: 'linear', elasticity: 400, autoplay: false, enabled: true, startEvents: 'animationcomplete__spawn', pauseEvents: 'mousedown', resumeEvents: 'resume'},
		stun: {property: 'material.color', to: '#d12323', dur: 1, delay: 0, loop: false, dir: 'normal', easing: 'linear', elasticity: 400, autoplay: false, enabled: true, startEvents: 'mousedown',},
		stun2: {property: 'material.emissive', to: '#d12323', dur: 1, delay: 0, loop: false, dir: 'normal', easing: 'linear', elasticity: 400, autoplay: false, enabled: true, startEvents: 'mousedown',},
		...
		resume: {property: 'material.color', to: '#cdef14', dur: 1, delay: 0, loop: false, dir: 'normal', easing: 'linear', elasticity: 400, autoplay: false, enabled: true, startEvents: 'resume'},
		resume2: {property: 'material.emissive', to: '#cdef14', dur: 1, delay: 0, loop: false, dir: 'normal', easing: 'linear', elasticity: 400, autoplay: false, enabled: true, startEvents: 'resume'},
		spawnx: {property: 'object3D.scale.x', from: 0.0001, to: 1, dur: 1000, delay: 0, loop: false, dir: 'normal', easing: 'easeInOutElastic', elasticity: 400, autoplay: true, enabled: true,},
		spawny: {property: 'object3D.scale.y', from: 0.0001, to: 1, dur: 1000, delay: 0, loop: false, dir: 'normal', easing: 'easeInOutElastic', elasticity: 400, autoplay: true, enabled: true,},
		spawnz: {property: 'object3D.scale.z', from: 0.0001, to: 1, dur: 1000, delay: 0, loop: false, dir: 'normal', easing: 'easeInOutElastic', elasticity: 400, autoplay: true, enabled: true,},
	...
	components: {
		...
		oneventrun__kill2:{
			event: 'animationcomplete__killz',
			cursorObj: hordeHalt.id,
			component: 'null',
			method: 'DespawnEnemy',
			params: '0',
	...
	hordeHalt.hordeHaltUI.layer.all.child5.core.core.components.clickrun__next = {cursorObj: hordeHalt.id, component: 'null', method: 'GameLoop', params: 'null',};
	...
	const Countdown = (count) => {
		...
		hordeHalt.target.EmitEvent('countdown');
		let countTimeout = setTimeout(() => {
			if(count > 1){
				Countdown(count-1);
			} else {
	...
	const SpawnEnemies = (amount) => {
		let spawned = 0;
		hordeHalt.enemyCores.every(enemy => {
			if(enemy.core.inScene){}else{
				enemy.SpawnCore();
				spawned++;
			}
			if(spawned >= amount){
	...
	//Despawn Enemy
	const DespawnEnemy = (enemy) => {
		hordeHalt.enemyCores[enemy].DespawnCore();
	}
	//Despawn Enemies
	const DespawnEnemies = () => {
		for(let a = 0; a < hordeHalt.enemyCores.length; a++){
			if(hordeHalt.enemyCores[a].core.inScene){
				clearTimeout(hordeHalt.enemies[a].resumeTimeout);
 				hordeHalt.enemyCores[a].DespawnCore();
			}
		}
	}
	//Update Enemies
	const UpdateEnemies = () => {
		...
		hordeHalt.enemyCores.forEach(enemy => {
			x = (Math.random()*hordeHalt.spawnDistance)-hordeHalt.spawnDistance/2;
			y = (Math.random()*hordeHalt.spawnDistance)+0.5;
			z = (Math.random()*-10)-hordeHalt.spawnDistance;
			enemy.core.position = new THREE.Vector3(x,y,z);
		});
	}
	//Reset
	const Reset = () => {
		clearTimeout(hordeHalt.gameDelay);
		clearInterval(hordeHalt.spawnInterval);
		hordeHalt.level = 1;
		hordeHalt.health = 5;
		hordeHalt.totalKills = 0;
		hordeHalt.kills = 0;
		...
		hordeHalt.enemyHealth = enemyHealth;
		UpdateEnemies();
		hordeHalt.hordeHaltUI.GetChild('hordeHaltUI6').ChangeSelf({property:'visible',value: false});
	}
	//Game Start
	const GameStart = () => {
		Reset();
		hordeHalt.gameStarted = true;
		hordeHalt.hordeHaltUI.GetChild('hordeHaltUI5').ChangeSelf({property:'text',value:{value:'Restart'}});
		GameLoop();
	}
	//Game Over
	const GameOver = () => {
		...
		hordeHalt.hordeHaltUI.GetChild('hordeHaltUI5').ChangeSelf({property:'text',value:{value:'Start'}});
	}
	//Game Loop
	const GameLoop = () => {
		hordeHalt.hordeHaltUI.GetChild('hordeHaltUI6').ChangeSelf({property:'visible',value: false});
		hordeHalt.hordeHaltUI.GetChild('hordeHaltUI3').ChangeSelf({property:'text',value:{value:'Health '+hordeHalt.health+'\nKills: '+hordeHalt.kills+'\nLeft: '+(hordeHalt.levelKills - hordeHalt.kills)+'\nTotal: '+hordeHalt.totalKills}});
		Countdown(3);
		hordeHalt.gameDelay = setTimeout(() => {
			hordeHalt.target.EmitEvent('levelStart');
			SpawnEnemies(hordeHalt.spawnTotal);
			hordeHalt.spawnInterval = setInterval(() => {
				SpawnEnemies(hordeHalt.spawnTotal);
			}, hordeHalt.spawnRate);
		}, 3000);
	}
	...
	const LevelProgression = () => {
		...
		hordeHalt.levelKills = levelKills + (hordeHalt.level*3);
		hordeHalt.enemyHealth = enemyHealth + Math.floor(hordeHalt.level/10);
		hordeHalt.spawnDistance = spawnDistance + hordeHalt.level;
		if(hordeHalt.spawnTotal < 30){
			hordeHalt.spawnTotal = spawnTotal + Math.floor(hordeHalt.level/3);
		}
		if(hordeHalt.spawnRate > 200){
			hordeHalt.spawnRate = spawnRate - (Math.floor(hordeHalt.level/5)*100);
		}
		if(hordeHalt.resumeSpeed > 200){
			hordeHalt.resumeSpeed = resumeSpeed - (Math.floor(hordeHalt.level/10)*100);
		}
	}
	//Level Complete
	const LevelComplete = () => {
		clearInterval(hordeHalt.spawnInterval);
		clearTimeout(hordeHalt.gameDelay);
		hordeHalt.target.EmitEvent('levelOver');
		DespawnEnemies();
		hordeHalt.hordeHaltUI.GetChild('hordeHaltUI1').ChangeSelf({property:'text',value:{value:'Level '+hordeHalt.level+' Complete!'}});
		LevelProgression();
		UpdateEnemies();
		hordeHalt.hordeHaltUI.GetChild('hordeHaltUI6').ChangeSelf({property:'visible',value: true});
	}
	//Damage
	const Damage = (enemy) => {
		hordeHalt.hordeHaltUI.GetChild('hordeHaltUI1').ChangeSelf({property:'text',value:{value:'Damaged'}});
		hordeHalt.health--;
		hordeHalt.enemyCores[enemy].EmitEvent('damage');
		hordeHalt.target.EmitEvent('damage');
		hordeHalt.hordeHaltUI.GetChild('hordeHaltUI3').ChangeSelf({property:'text',value:{value:'Health '+hordeHalt.health+'\nKills: '+hordeHalt.kills+'\nLeft: '+(hordeHalt.levelKills - hordeHalt.kills)+'\nTotal: '+hordeHalt.totalKills}});
	...
	//Stun
	const Stun = (enemy) => {
		hordeHalt.hordeHaltUI.GetChild('hordeHaltUI1').ChangeSelf({property:'text',value:{value:'Stunned'}});
	...
	const SlashOut = (enemy) => {
		if(hordeHalt.enemies[enemy].stunned && hordeHalt.enemies[enemy].slashStart){
			...
			hordeHalt.hordeHaltUI.GetChild('hordeHaltUI1').ChangeSelf({property:'text',value:{value:'Hit'}});
	...
	//Kill
	const Kill = (enemy) => {
		hordeHalt.hordeHaltUI.GetChild('hordeHaltUI1').ChangeSelf({property:'text',value:{value:'Killed!'}});
		hordeHalt.kills++;
		hordeHalt.totalKills++;
		clearTimeout(hordeHalt.enemies[enemy].resumeTimeout);
		hordeHalt.enemyCores[enemy].EmitEvent('kill');
		hordeHalt.hordeHaltUI.GetChild('hordeHaltUI3').ChangeSelf({property:'text',value:{value:'Health '+hordeHalt.health+'\nKills: '+hordeHalt.kills+'\nLeft: '+(hordeHalt.levelKills - hordeHalt.kills)+'\nTotal: '+hordeHalt.totalKills}});
		if(hordeHalt.kills >= hordeHalt.levelKills){
			LevelComplete();
		} else {
			hordeHalt.enemies[enemy].stunned = false;
			hordeHalt.enemies[enemy].health = hordeHalt.enemyHealth;
			hordeHalt.enemies[enemy].slashStart = false;
			let x = (Math.random()*hordeHalt.spawnDistance)-hordeHalt.spawnDistance/2;
			let y = (Math.random()*hordeHalt.spawnDistance)+0.5;
			let z = (Math.random()*-10)-hordeHalt.spawnDistance;
			hordeHalt.enemyCores[enemy].core.position = new THREE.Vector3(x,y,z);
		}
	}
	...
	return {hordeHalt, core, SpawnHHGame, DespawnHHGame, GameStart, GameLoop, Stun, SlashIn, SlashOut, Damage, ToggleClick, DespawnEnemy}
}
auxl.AddObjGenToTracker('hordeHalt', 'SpawnHHGame', 'DespawnHHGame');
...
auxl.AddObjGenToTracker('basic', 'SpawnBasicGame', 'DespawnBasicGame');
